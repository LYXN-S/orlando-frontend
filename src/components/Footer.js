    ...
    <footer className="bg-espresso text-white">
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/products" className="text-sm text-white/70 transition-colors hover:text-white">
                  Products
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/orders" className="text-sm text-white/70 transition-colors hover:text-white">
                  Orders
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-xs text-white/40">
          &copy; {new Date().getFullYear()} Orlando. All rights reserved. Authentic Italian Quality.
        </div>
      </div>
    </footer>
  );
